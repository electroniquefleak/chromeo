...
const ColorCircle = ({ id, hex, enabled, toggleCircle, fetchTracksSpotify, message}) => {
    ...
    return (
    <>
        <span className="colorCircle" style={{backgroundImage: `radial-gradient(circle at 35%, #FFFFFF, ${hex})`}} onClick={handleToggle} onMouseEnter={handlePopoverOpen} onMouseLeave={handlePopoverClose}></span>
        <Snackbar
